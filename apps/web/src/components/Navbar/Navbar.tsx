    ...
    return (
        ...
        >
            <XStack
                ...
                onPress={() =>
                    pathname !== "/calendar" && router.push("/calendar")
                }
            >
                <Image
                    src={Images.Logo}
...
function PrivateNavbar() {
    ...
    const avatarSrc =
        profileData?.avatar && profileData.avatar !== "placeholder"
            ? profileData.avatar
            : profileData?.username
              ? `https://ui-avatars.com/api/?name=${encodeURIComponent(profileData.username)}`
              : undefined;
        ...
        >
            ...
            >
                ...
                <XStack
                    style={{ display: "flex", alignItems: "center", gap: 10 }}
                    cursor={
                        pathname.startsWith("/profile") ? "pointer" : "auto"
                    }
